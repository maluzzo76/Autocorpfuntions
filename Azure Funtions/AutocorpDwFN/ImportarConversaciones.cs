...
{
    public class ImportarConversaciones
    {
        ...
        private readonly ILogger<ImportarConversaciones> _logger;

        public ImportarConversaciones(ILogger<ImportarConversaciones> logger)
        {
            _logger = logger;
        }
        ...
        public IActionResult Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequest req)
        {
            ...
            string ticketId = req.Query["codigo"];
            ...
            {                 
                    ...
                    try
                    {
                        ...
                        string apiUrl = $"https://autocorpar.freshdesk.com/api/v2/tickets/{ticketId}/conversations";
